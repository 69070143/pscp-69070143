...
```text
รับข้อความและเปลี่ยนให้ตัวอักษรเรียงจากหลังไปหน้า

input:
รับข้อความภาษาอังกฤษความยาว5ตัวอักษร

output:
แสดงข้อความแบบกลับด้านแล้ว เป็นตัวพิมพ์เล็กทั้งหมด
```
...
```text
Step 1: รับข้อความ
Step 2: แสดงข้อความที่กลับด้านแล้วโดยเปลี่ยนเป็นตัวพิมพ์เล็กทั้งหมด
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก เพราะเขียนสั้นและได้ผลตามที่โจทย์ต้องการ
```
...
```text
เคสที่มีตัวพิมพ์ใหญ่ผสม ควรแสดงผลออกมาเป็นตัวพิมพ์เล็กทั้งหมด
```
...
```text
เคสที่มีตัวพิมพ์ใหญ่ทั้งหมด ควรแสดงผลออกมาเป็นตัวพิมพ์เล็กทั้งหมด
```
