...
```text
เขียนโปรแกรมเพื่อหาว่า เจ้ากบน้อยต้องใช้การกระโดดอย่างน้อยกี่ครั้ง ถึงจะไปถึงเป้าหมายที่ระยะ Y เมตร
input:
รับค่า จํานวนเต็ม X และ Y

output:
แสดงผล จํานวนครั้งกระโดดขั้นตํ่าที่ทําให้ระยะรวม ≥ Y หรือ -1 ถ้าไปไม่ถึง
```
...
Step 2: กำหนดให้ x = int(text[0])
Step 3: กำหนดให้ y = int(text[1])
Step 4: กำหนดให้ distance = 0
Step 5: กำหนดให้ count = 0
Step 6: ใช้ for _ in range(x, 0, -2)
Step 7: คำนวณเพิ่มระยะทางโดยให้ distance += _
Step 8: เพิ่มจำนวนครั้งโดยให้ count += 1
Step 9: เช็คว่า distance >= y หรือไม่
Step 10: ถ้าใช่ ให้ออกจากรูกลูปด้วย break
Step 11: เช็คว่า distance < y หรือไม่
Step 12: ถ้าใช่ กำหนดให้ count = 0 และพิมพ์ "-1"
Step 13: ถ้าไม่ใช่ ให้พิมพ์ค่า count
```
