...
constraints:
สีที่รับค่ามาต้องเป็นแม่สีเท่านั้น (Red , Blue , Yellow) ถ้านอกเหนือจากนี้จะแสดงผล "Error"
```
...
Step 2: ตรวจว่า ทั้งสองสีเป็นแม่สีสีเดียวกันหรือไม่
Step 3: ถ้าจริง ให้แสดงผล สีนั้นออกมา
Step 4: ถ้าไม่จริง ให้ตรวจสอบต่อว่าสีทั้งสองคือแม่สีคู่ไหนผสมกัน
Step 5: หากเป็นคู่สีที่กำหนดไว้ให้แสดงผลสีที่ผสมกันแล้วตามที่เขียนโปรแกรมไว้
Step 6: หากไม่ใช่แม่สีผสมกัน ให้แสดงผลว่า"Error"
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก เพราะมีความรัดกุมและมีโอกาสผิดพลาดน้อย
```
