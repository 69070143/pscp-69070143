...
```text
หาว่าจำนวนนับ x ในช่วง [A , B] มีกี่จํานวน ที่หารด้วยจํานวนนับ d แล้วเหลือเศษ r
input:
รับค่า A
รับค่า B
รับค่า d(ตัวหาร)
...
output:
จำนวน x ทั้งหมดกี่จำนวนที่หารด้วยจํานวนนับ d แล้วเหลือเศษ r
```
...
Step 1: รับค่า A
Step 2: รับค่า B
Step 3: รับค่า d(ตัวหาร)
Step 4: รับค่า r(เศษ)
Step 5: กำหนดให้ i = A
Step 6: กำหนดให้ count = 0
Step 7: ใช้ for i in range(A,B+1) เช็คว่า i อยู่ในช่วงหรือไม่ โดยให้ i เพิ่มทีละ 1
Step 8: ถ้าใช่ ให้เช็คต่อว่า
Step 9: i % d == r (i หารด้วย d แล้วเหลือเศษ r) หรือไม่
Step 10: ถ้าใช่ ให้ค่า count += 1
Step 11: ถ้าไม่อยู่ในช่วง ให้แสดงผลค่า count
```
...
```text
วิธีสุดท้ายเหมือนแผนแรก ฉันใช้ for loop เช็คว่าแต่ละค่าในช่วงตรงเงื่อนไขหรือไม่
ถ้าตรงเงื่อนไขให้เก็บค่าจำนวนที่ตรงเงื่อนไข (count) เพิ่มทีละ 1
```
