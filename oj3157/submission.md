...
```text
เขียนโปรแกรมหาคะแนนรวมหลังจากทําครบทุกคําสั่ง
input:
รับค่า n จํานวนครั้งของการกระทํา
รับค่า คําสั่ง จำนวน n บรรทัด (คําสั่งมีได้ 2 แบบคือ + (เพิ่ม 10 คะแนน) และ - (ลด 5 คะแนน))
...
```text
Step 1: กำหนดให้ score = 0
Step 2: อ่านค่าจำนวนรอบ n
Step 3: วนลูปรับค่าคำสั่ง command จำนวน n รอบ
Step 4: ตรวจสอบว่า command == "+" หรือไม่
Step 5: ถ้าจริง ให้เพิ่มคะแนน score ขึ้น 10
Step 6: ถ้าไม่จริง ให้ลดคะแนน score ลง 5
Step 7: พิมพ์ค่า score ออกมาเมื่อจบลูป
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก  ใช้ for loop ในการเช็ค command จำนวน n รอบ
```
