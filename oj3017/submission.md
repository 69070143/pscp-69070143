...
```text
Input:
รับค่าราคาอาหารเป็นจำนวนเต็ม

Output:
แสดงผลราคาอาหารที่คิดรวมค่า service charge และvat 7% (ทศนิยม 2 ตำแหน่ง)

Constraints:
ค่าservice charge กำหนดไว้ที่ 10% ของราคาอาหาร แต่จะคิดอย่างน้อย 50 บาท แต่จะไม่เกิน 1000 บาทด้วย
```
...
```text
Step 1: รับค่าอาหารเป็นจำนวนเต็ม
Step 2: คำนวณ service charge 10% ของราคาอาหาร
Step 3: ตรวจสอบว่า service charge มีค่า < 50 หรือไม่
Step 4: ถ้าจริง ให้เปลี่ยนค่า service charge == 50
Step 5: ถ้าไม่จริง ให้คงค่าเดิมไว้
Step 6: ตรวจสอบว่า service charge มีค่า > 1000 หรือไม่
Step 7: ถ้าจริง ให้เปลี่ยนค่า service charge == 1000
Step 8: ถ้าไม่จริง ให้คงค่าเดิมไว้
Step 9: คำนวณค่า vat 7% ของราคาอาหารที่รวมค่า service charge แล้ว
Step 10: รวมค่าอาหาร , service charge และ vat
Step 11: พิมพ์ผลรวมค่าอาหาร , service charge และ vat (ทศนิยม 2 ตำแหน่ง)
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก เพราะรัดกุมทุกเงื่อนไขที่โจทย์กำหนดมา
```
