...
```text
ให้รับค่าอุณหภูมิเป็นหน่วยองศา ตามที่รับค่าเข้ามาว่าเป็นหน่วยอะไร และแสดงผลอุณหภูมิที่แปลงหน่วยแล้วตามที่โจทย์กำหนดมา (หน่วยเป็น C , K , F , R )

Input:
รับค่าอุณหภูมิ (float)
รับค่าหน่วยของอุณหภูมิในบรรทัดที่ 1
รับค่าหน่วยของอุณหภูมิที่ต้องการผลออกมา

Output:
พิมพ์ อุณหภูมิที่แปลงแล้ว เป็นหน่วยที่โจทย์ต้องการ
```
...
```text
Step 1: รับค่าอุณหภูมิ(temp) , หน่วยอุณหภูมิเริ่มต้น(start_unit) , หน่วยที่ต้องการแปลงออกมา(final_unit)
Step 2: ตรวจว่า หน่วยอุณหภูมิเริ่มต้นคืออะไร (C , K , F , R)
Step 3: ถ้า temp == "K" ให้เปลี่ยนค่า temp เป็นหน่วย Celsius ด้วยสูตร temp = temp - 273.15
Step 4: ถ้า temp == "F" ให้เปลี่ยนค่า temp เป็นหน่วย Celsius ด้วยสูตร temp = (temp - 32)*(5 / 9)
Step 5: ถ้า temp == "R" ให้เปลี่ยนค่า temp เป็นหน่วย Celsius ด้วยสูตร (temp * (5 / 9)) - 273.15
Step 6: ถ้า final_unit == "K" ให้ค่า ans เป็นหน่วย Kelvin ด้วยสูตร ans = temp + 273.15
Step 7: ถ้า final_unit == "F" ให้ค่า ans เป็นหน่วย Fahrenheit ด้วยสูตร ans = (temp * (9 / 5)) + 32
Step 8: ถ้า final_unit == "R" ให้ค่า ans เป็นหน่วย Rankine ด้วยสูตร ans = (temp + 273.15) * (9 / 5)
Step 9: ถ้า final_unit == "C" ให้ค่า ans = temp
Step 10: print ค่า ans ออกมา(ทศนิยม 2 ตำแหน่ง)
```
...
```text
เปลี่ยนจากหน่วย Celsius เป็น Kelvin
```
...
```text
เปลี่ยนจากหน่วย Fahrenheit เป็น Kelvin
```
...
```text
เปลี่ยนจากหน่วย Rankine เป็น Rankine
```
