...
```text
ให้บอกว่าวันที่และเดือนที่รับค่ามา เป็นฤดูอะไร

input:
โปรแกรมรับค่าเดือน และวันที่ เป็นจำนวนเต็ม

output:
โปรแกรมพิมพ์ ฤดูตามเงื่อนไข ดังนี้
เดือนที่ 1, 2, 3 พิมพ์ "winter"
เดือน 4, 5, 6 พิมพ์  "spring"
เดือนที่ 7, 8, 9 พิมพ์ "summer"
เดือน 10, 11, 12 พิมพ์  "fall"
แต่ฤดูกาลจะเปลี่ยนไปตั้งแต่วันที่ 21 ของเดือนที่หารด้วย 3 ลงตัว จาก winter > spring > summer > fall > winter
```
...
```text
Step 1: อ่านจำนวนเต็ม เดือน และวันที่
Step 2: ตรวจว่า เดือน อยู่ในช่วงเดือนของฤดูไหน
Step 3: ถ้าได้ช่วงฤดูแล้ว จะตรวจก่อนว่า เดือนหารด้วย 3 ลงตัว และ วันที่ >= 21 หรือไม่
Step 4: ถ้าจริง ให้พิมพ์ ฤดูถัดไปแทน
Step 5: ถ้าไม่จริง ให้พิมพ์ ฤดูตามช่วงเดือนที่กำหนด
```
...
```text
วิธีสุดท้ายของเหมือนกับแผนแรก โดยใช้ if เพื่อเช็คช่วงเดือนก่อน จากนั้นใช้ if อีกชั้นเพื่อเช็คว่าเป็นเดือนที่หารด้วย 3 ลงตัวและวันที่ >=21 ไหม ถ้าจริงให้พิมพ์ฤดูถัดไป(เปลี่ยนฤดู) ถ้าไม่จริงให้พิมพ์ฤดูตามช่วงเดือนที่กำหนดไว้ และใช้วิธีนี้สำหรับทุกฤดูที่โจทย์กำหนดมา (winter , spring , summer , fall)
```
...
```text
ตรวจตามเงื่อนไขว่าเป็นเดือนที่หารด้วย 3 ลงตัว และวันที่ >= 21 ไหม
ถ้าจริงควรเปลี่ยนเป็นฤดูถัดไป ถ้าไม่จริงให้พิมพ์ฤดูตามช่วงเดือนที่กำหนดไว้ในโปรแกรม
```
...
```text
case ปกติที่ไม่ใช่เดือนที่หารด้วย 3 ลงตัว
```
